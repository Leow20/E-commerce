    ...
    <>
      ...
      {tamanhoTela < 1077 ? (
        <div id='boxFunction' className='box-button-footer'>
          ...
          <button onClick={handleButtonFooter} className='icon-button-footer'> <img src={open === true ? ArrowUp : ArrowDown} alt="" /> </button>
        </div>
          ...
          <div className='container-footer container-footer-mobal'>
            ...
            {tamanhoTela < 1077 ? (
              <div className='coluna-footer policy-footer'>
                <h4>Policy</h4>
                <div className='mob-policy'>
                  <p> <Link to="">Return</Link> | <Link to="">Terms of use</Link> | <Link to="">Sitemap</Link> | <Link to="">Security</Link> | <Link to="">Privacy</Link> | <Link to="">EPR Compliance</Link></p>
                </div>
              </div>
            ) : (
